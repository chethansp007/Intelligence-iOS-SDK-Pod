...
/**
  The password provided is too weak. See \code
  Intelligence.User
  \endcode password field to see
...
*/
+ (INTConfiguration * _Nullable)configurationFromFile:(NSString * _Nonnull)file inBundle:(NSBundle * _Nonnull)bundle error:(NSError * _Nullable * _Nullable)error;
/**

  returns:
  A copy of the configuration object.
*/
- (INTConfiguration * _Nonnull)clone;
/**
